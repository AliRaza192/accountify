...
export default function NewBillPage() {
  ...
  const getItemTax = (item: BillItem) => {
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-4 mb-6">
        ...
        <div>
          ...
          <p className="text-gray-500 mt-1">Create a new purchase bill</p>
        </div>
      </div>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 space-y-6">
        ...
        <div>
          ...
          {items.length === 0 && (
            <div className="text-center py-8 text-gray-500">
              ...
              <p>No items added. Click "Add Row" to add items to this bill.</p>
            </div>
          )}
        </div>
        ...
        <div className="flex items-center gap-4 pt-6 border-t border-gray-100">
          ...
          >
            {isLoading ? "Creating..." : "Confirm Bill"}
          </Button>
          <Link
            href="/dashboard/purchase/bills"
